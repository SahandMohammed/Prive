...
public static class AccountingChartSeeder
{
  ...
  [
    ...
    new("134111", "نقدية لدى صندوق المركز بالعملة المحلية", AccountClassification.Asset, true, "13411"),
    new("134112", "نقدية لدى صندوق المركز بالعملة الأجنبية", AccountClassification.Asset, true, "13411"),
    new("13412", "نقدية لدى صندوق الفروع", AccountClassification.Asset, true, "1341"),
    new("134121", "نقدية لدى صندوق الفروع بالعملة المحلية", AccountClassification.Asset, true, "13412"),
    new("134122", "نقدية لدى صندوق الفروع بالعملة الأجنبية", AccountClassification.Asset, true, "13412"),
    new("1342", "نقدية لدى المصارف", AccountClassification.Asset, true, "134"),
    new("13421", "نقدية لدى المصارف بالعملة المحلية", AccountClassification.Asset, true, "1342"),
    new("13422", "نقدية لدى المصارف بالعملة الأجنبية", AccountClassification.Asset, true, "1342"),
