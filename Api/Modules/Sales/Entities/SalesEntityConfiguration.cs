...
public sealed class SalesInvoiceLineEntityConfiguration : IEntityTypeConfiguration<SalesInvoiceLineEntity>
{
  public void Configure(EntityTypeBuilder<SalesInvoiceLineEntity> builder)
  {
    ...
    builder.Property(line => line.UnitPrice).HasPrecision(19, 6).IsRequired();
    builder.Property(line => line.BaseUnitPrice).HasPrecision(19, 6).IsRequired();
    ...
    builder.HasOne(line => line.Professional).WithMany().HasForeignKey(line => line.ProfessionalId).OnDelete(DeleteBehavior.Restrict);
    builder.HasIndex(line => line.ProfessionalId);
  }
}
