...
public sealed record OpeningStockLineResponse(Guid Id, Guid ProductId, string ProductName, string SKU, Guid UnitOfMeasureId, string UnitCode, decimal Quantity, UnitConversionOperation? ConversionOperation, decimal ConversionFactor, decimal BaseQuantity, decimal UnitCost, decimal UnitCostBase, decimal LineValueBase);
...
public sealed record OpeningStockLineRequest([Required] Guid ProductId, [Required] Guid UnitOfMeasureId, [Range(typeof(decimal), "0.0001", "999999999999999")] decimal Quantity, [Range(typeof(decimal), "0", "999999999999999")] decimal UnitCost);
