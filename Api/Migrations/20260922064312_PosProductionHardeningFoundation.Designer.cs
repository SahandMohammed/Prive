...
namespace api.Migrations
{
    ...
    [Migration("20260922064312_PosProductionHardeningFoundation")]
    partial class PosProductionHardeningFoundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Modules.Expenses.ExpenseDocumentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Api.Modules.Expenses.ExpenseLineEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ExpenseAccountingAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ExpenseAccountingAccountId");
            ...
            modelBuilder.Entity("Api.Modules.Inventory.StockMovementEntity", b =>
                {
                    ...
                    b.Property<Guid?>("PosRefundLineId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Api.Modules.Pos.PosRefundEntity", b =>
                {
                    ...
                    b.Property<decimal>("TotalRefundBase")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)");
            ...
            modelBuilder.Entity("Api.Modules.Pos.PosRefundLineEntity", b =>
                {
                    ...
                    b.Property<decimal?>("OriginalUnitCostBase")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)");

                    b.Property<Guid>("PosRefundId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("RefundAmountBase")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)");

                    b.Property<bool>("RestockProduct")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("PosRefundId", "OriginalSalesInvoiceLineId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Api.Modules.Expenses.ExpenseDocumentEntity", b =>
                {
                    ...
                    b.HasOne("Api.Modules.Contact.ContactEntity", "Contact")
                        .WithMany()
                    ...
                    b.HasOne("Api.Modules.Accounting.JournalEntryEntity", "JournalEntry")
                        .WithOne("SourceExpenseDocument")
                        .HasForeignKey("Api.Modules.Expenses.ExpenseDocumentEntity", "JournalEntryId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Api.Modules.User.UserEntity", "PostedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Api.Modules.Expenses.ExpenseLineEntity", b =>
                {
                    b.HasOne("Api.Modules.Accounting.AccountEntity", "ExpenseAccountingAccount")
                        .WithMany()
                        .HasForeignKey("ExpenseAccountingAccountId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Api.Modules.Expenses.ExpenseCategoryEntity", "ExpenseCategory")
                        .WithMany("Lines")
                        .HasForeignKey("ExpenseCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Api.Modules.Expenses.ExpenseDocumentEntity", "ExpenseDocument")
                        .WithMany("Lines")
                        .HasForeignKey("ExpenseDocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExpenseAccountingAccount");
            ...
            modelBuilder.Entity("Api.Modules.Inventory.StockMovementEntity", b =>
                {
                    ...
                    b.HasOne("Api.Modules.Pos.PosRefundLineEntity", "PosRefundLine")
                        .WithMany("StockMovements")
                        .HasForeignKey("PosRefundLineId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Api.Modules.Pos.PosRefundEntity", b =>
                {
                    b.HasOne("Api.Modules.User.UserEntity", "ApprovedByUser")
                        .WithMany()
                    ...
                    b.HasOne("Api.Modules.Accounting.JournalEntryEntity", "JournalEntry")
                        .WithOne("SourcePosRefund")
                        .HasForeignKey("Api.Modules.Pos.PosRefundEntity", "JournalEntryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
